...
class WC_PIP_Document_Pick_List extends WC_PIP_Document_Packing_List {
	...
	private function get_category_table_rows() {
		...
		/**
		 * Filters the table row cells of a pick list document.
		 *
		 * @since 3.6.0
		 *
		 * @param array $table_row_cells associative array of table data
		 * @param \WC_PIP_Document_Pick_List document object
		 */
		return (array) apply_filters( 'wc_pip_pick_list_document_table_row_cells', $new_table_rows, $this );
	}
