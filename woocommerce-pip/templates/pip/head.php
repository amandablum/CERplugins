...
<html <?php language_attributes(); ?>>
	<head>
		...
		<title>
			 ...
			 */
			echo apply_filters( 'wc_pip_document_title', sprintf( esc_html( '%1$s - %2$s %3$s' ), Framework\SV_WC_Helper::get_site_name(), $document->name, $document->get_invoice_number() ), $type, $document, $order );
